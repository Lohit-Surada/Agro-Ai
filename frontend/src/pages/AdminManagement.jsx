...
const AdminManagement = () => {
  ...
  const fetchAdmins = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/auth/admins/`, { headers });
  ...
  const handleCreate = async (event) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/auth/admins/create/`, formData, { headers });
  ...
  const handleDelete = async (username) => {
    try {
      await axios.delete(`${import.meta.env.VITE_API_BASE_URL}/api/auth/admins/${username}/`, { headers });
