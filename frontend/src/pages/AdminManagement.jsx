...
const AdminManagement = () => {
  ...
  const fetchAdmins = async () => {
    try {
      const response = await axios.get(`https://agro-aip-3.onrender.com/api/auth/admins/`, { headers });
  ...
  const handleCreate = async (event) => {
    ...
    try {
      const response = await axios.post(`https://agro-aip-3.onrender.com/api/auth/admins/create/`, formData, { headers });
  ...
  const handleDelete = async (username) => {
    try {
      await axios.delete(`https://agro-aip-3.onrender.com/api/auth/admins/${username}/`, { headers });
